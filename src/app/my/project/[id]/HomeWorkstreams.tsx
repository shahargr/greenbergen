...
// The standing services every home starts with (blueprint_home_projects),
  ...
  return (
    <div className="card" style={{ display: "grid", gap: 8 }}>
      ...
      <p className="muted small" style={{ margin: 0 }}>
        The services every home comes with. Switch one off to take it off your hub and lists — its
        tasks, files and payments stay put, and you can switch it back on any time.
      </p>
