...
create table public.project_bookings (
  ...
  budget_band            text,
  note                   text,
  state                  text not null default 'posted' constraint chk_project_bookings_state check (state in ('posted','accepted','closed','done')),
