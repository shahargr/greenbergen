...
--
-- Applied to Supabase on 2026-09-12 as v292_a_home_you_sold_is_not_your_home
-- (version 20260912152043) and live ever since. Its only file sat on
-- claude/backup-design-improvements-7ruyo4, which nothing merged. Filed at
-- the end of the series rather than at 078, because the repo's numbering
-- restarted on 2026-09-13 and 078 is already a different migration
-- (078_money_gathers_under_the_trade_that_spent_it). The number is a
-- filename; this header is the chronology. Nothing here is re-applied.
--
-- Text taken from supabase_migrations.schema_migrations, not from the
-- branch, and fingerprinted against it: identical.
--
-- ---------------------------------------------------------------------
